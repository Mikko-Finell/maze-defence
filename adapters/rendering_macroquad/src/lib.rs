...
impl ControlPanelInputState {
    ...
    /// Returns whether the control panel requested a replay and clears the latch.
    ...
    /// Records that the control-panel button requested a replay this frame.
...
fn draw_control_panel(
    ...
    Some(ControlPanelUiContext {
        ...
        replay_available: scene.replay_available,
    })
}
