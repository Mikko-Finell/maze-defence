...
/// Cell-sized wall occupying a single navigation coordinate inside the maze.
#[derive(Clone, Copy, Debug, PartialEq)]
pub struct WallCellPresentation {
...
impl WallCellPresentation {
    /// Creates a new wall cell descriptor.
    #[must_use]
    pub const fn new(column: u32, row: u32) -> Self {
        Self { column, row }
    }
...
pub struct Scene {
    ...
    /// Interior maze walls that occupy navigation cells.
    pub walls: Vec<WallCellPresentation>,
...
impl Scene {
    ...
    pub fn new(
        ...
        walls: Vec<WallCellPresentation>,
